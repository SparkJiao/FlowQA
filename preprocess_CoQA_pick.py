...
trn_file = 'CoQA/coqa-dev-pick25.json'
dev_file = 'CoQA/25_dev.json'
...
with open('CoQA/pick1_meta.msgpack', 'wb') as f:
    msgpack.dump(meta, f)
...
with open('CoQA/pick1_data.msgpack', 'wb') as f:
...
with open('CoQA/pick2_meta.msgpack', 'wb') as f:
    msgpack.dump(meta, f)
...
with open('CoQA/pick2_data.msgpack', 'wb') as f:
    msgpack.dump(result, f)
