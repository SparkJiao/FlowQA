...
class FlowQA(nn.Module):
    ...
    def __init__(self, opt, embedding=None, padding_idx=0):
        ...
        """ @Spark Jiao """
        self.iterator1 = layers.DocumentAttn(doc_hidden_size, opt['hidden_size'], num_layers=2)
        self.iterator2 = layers.DocumentAttn(doc_hidden_size, opt['hidden_size'], num_layers=2)
        self.iterator3 = layers.DocumentAttn(doc_hidden_size, opt['hidden_size'], num_layers=2)
